#ifndef GRAPH_GENERATOR_GRAPH_HPP
#define GRAPH_GENERATOR_GRAPH_HPP
  ...
  namespace graph_generator {
    class Graph {
     ...
     public:
      ...
      void set_store_node_names(bool store_node_names) {
        this->store_node_names = store_node_names;
      }
...
#endif  // GRAPH_GENERATOR_GRAPH_HPP
