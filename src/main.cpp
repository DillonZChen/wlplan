...
PYBIND11_MODULE(_wlplan, m) {
  ...
  // Predicate
  py::class_<planning::Predicate>(planning_m,
                                  "Predicate",
                                  R"(Parameters
----------
    name : str
    ...
    arity : int
      ...
      .def(py::pickle(&__getstate__<planning::Predicate>, &__setstate__<planning::Predicate>));

  // Function
  py::class_<planning::Function>(planning_m,
                                 "Function",
                                 R"(Parameters
----------
    name : str
    ...
    arity : int
      ...
      .def(py::pickle(&__getstate__<planning::Function>, &__setstate__<planning::Function>));

  // Schema
  py::class_<planning::Schema>(planning_m,
                               "Schema",
                               R"(Parameters
----------
    name : str
    ...
    arity : int
      ...
      .def(py::pickle(&__getstate__<planning::Schema>, &__setstate__<planning::Schema>));

  // Domain
  py::class_<planning::Domain>(planning_m,
                               "Domain",
                               R"(Parameters
----------
    name : str
    ...
    constant_objects : list[Object], optional
      ...
      .def(py::pickle(&__getstate__<planning::Domain>, &__setstate__<planning::Domain>));

  /* Task components */

  // Object
  py::class_<planning::Object>(
      planning_m,
      "Object",
  ...
  // Action
  py::class_<planning::Action>(planning_m,
                               "Action",
                               R"(Parameters
----------
    schema : Schema
    ...
    objects : list[Object]
      ...
      .def(py::pickle(&__getstate__<planning::Action>, &__setstate__<planning::Action>));

  // Atom
  py::class_<planning::Atom>(planning_m,
                             "Atom",
                             R"(Parameters
----------
    predicate : Predicate
    ...
    objects : list[Object]
      ...
      .def(py::pickle(&__getstate__<planning::Atom>, &__setstate__<planning::Atom>));

  // Fluent
  py::class_<planning::Fluent>(planning_m,
                               "Fluent",
                               R"(Parameters
----------
    function : Function
    ...
    objects : list[Object]
      ...
      .def(py::pickle(&__getstate__<planning::Fluent>, &__setstate__<planning::Fluent>));
  ...
  py::class_<planning::NumericExpression, std::shared_ptr<planning::NumericExpression>>(
      planning_m,
      "NumericExpression",
  ...
  // FormulaExpression
  py::class_<planning::FormulaExpression,
             planning::NumericExpression,
             std::shared_ptr<planning::FormulaExpression>>(planning_m,
                                                           "FormulaExpression",
                                                           R"(Parameters
----------
    ...
    expr_b : NumericExpression
      ...
      .def(py::init<planning::OperatorType,
                    std::shared_ptr<planning::NumericExpression> &,
                    std::shared_ptr<planning::NumericExpression> &>(),
           "op_type"_a,
           "expr_a"_a,
           "expr_b"_a);
  ...
  // ConstantExpression
  py::class_<planning::ConstantExpression,
             planning::NumericExpression,
             std::shared_ptr<planning::ConstantExpression>>(planning_m,
                                                            "ConstantExpression",
                                                            R"(Parameters
----------
    value : float
  ...
  // FluentExpression
  py::class_<planning::FluentExpression,
             planning::NumericExpression,
             std::shared_ptr<planning::FluentExpression>>(planning_m,
                                                          "FluentExpression",
                                                          R"(Parameters
----------
    id : int
  ...
  // NumericCondition
  py::class_<planning::NumericCondition>(planning_m,
                                         "NumericCondition",
                                         R"(Parameters
----------
    ...
    expression : NumericExpression
      ...
      .def("evaluate_formula_and_error",
           &planning::NumericCondition::evaluate_formula_and_error,
           "values"_a)
      .def(py::pickle(&__getstate__<planning::NumericCondition>,
                      &__setstate__<planning::NumericCondition>));

  // Problem
  py::class_<planning::Problem>(planning_m,
                                "Problem",
                                R"(Parameters
----------
    domain : Domain
    ...
    numeric_goals : list[NumericCondition], optional
      ...
      .def("__repr__", &planning::Problem::to_string)
      .def("__eq__", &planning::Problem::operator==)
      .def(py::pickle(&__getstate__<planning::Problem>, &__setstate__<planning::Problem>));

  // State
  py::class_<planning::State>(planning_m,
                              "State",
                              R"(Parameters
----------
    atoms : list[Atom]
    ...
    values : list[float], optional
      ...
      .def(py::init<const std::vector<planning::Atom> &>(), "atoms"_a)
      ...
      .def(py::pickle(&__getstate__<planning::State>, &__setstate__<planning::State>));
  ...
  // DomainDataset
  py::class_<data::DomainDataset>(data_m,
                                  "DomainDataset",
...
----------
  ...
  // ProblemDataset
  py::class_<data::ProblemDataset>(data_m,
                                   "ProblemDataset",
...
----------
  ...
  // Graph
  py::class_<graph_generator::Graph, std::shared_ptr<graph_generator::Graph>>(
      graph_generator_m,
      "Graph",
...
-------
    ...
    dump() -> None
      ...
      .def("get_node_name", &graph_generator::Graph::get_node_name, "u"_a)
  ...
  py::class_<graph_generator::GraphGenerator>(graph_generator_m, "GraphGenerator")
      ...
      .def("to_graphs", &graph_generator::GraphGenerator::to_graphs, "dataset"_a)
      .def("set_problem", &graph_generator::GraphGenerator::set_problem, "problem"_a)
      .def("to_graph",
  ...
  // ILGGenerator
  py::class_<graph_generator::ILGGenerator, graph_generator::GraphGenerator>(graph_generator_m,
                                                                             "ILGGenerator")
      .def(py::init<planning::Domain &, bool>(), "domain"_a, "differentiate_constant_objects"_a);

  // NILGGenerator
  py::class_<graph_generator::NILGGenerator, graph_generator::ILGGenerator>(graph_generator_m,
                                                                            "NILGGenerator")
      .def(py::init<planning::Domain &, bool>(), "domain"_a, "differentiate_constant_objects"_a);
  ...
  py::class_<feature_generator::Features>(feature_generator_m, "Features")
      .def("collect",
           py::overload_cast<const data::DomainDataset>(
               &feature_generator::Features::collect_from_dataset),
           "dataset"_a)
      .def("collect",
           py::overload_cast<const std::vector<graph_generator::Graph> &>(
               &feature_generator::Features::collect),
           "graphs"_a)
      .def("to_graphs", &feature_generator::Features::to_graphs, "dataset"_a)
      .def("set_problem", &feature_generator::Features::set_problem, "problem"_a)
      .def("get_string_representation",
           py::overload_cast<const feature_generator::Embedding &>(
               &feature_generator::Features::get_string_representation),
           "embedding"_a)
      .def("get_string_representation",
           py::overload_cast<const planning::State &>(
               &feature_generator::Features::get_string_representation),
           "state"_a)
      .def("embed",
           py::overload_cast<const data::DomainDataset &>(
               &feature_generator::Features::embed_dataset),
           "dataset"_a)
      .def("embed",
           py::overload_cast<const std::vector<graph_generator::Graph> &>(
               &feature_generator::Features::embed_graphs),
           "graphs"_a)
      .def("embed",
           py::overload_cast<const graph_generator::Graph &>(
               &feature_generator::Features::embed_graph),
           "graph"_a)
      .def("embed",
      ...
      .def("set_pruning", &feature_generator::Features::set_pruning, "pruning"_a)
      .def("set_weights", &feature_generator::Features::set_weights, "weights"_a)
      .def("get_weights", &feature_generator::Features::get_weights)
      .def("predict",
           py::overload_cast<const graph_generator::Graph &>(&feature_generator::Features::predict),
           "graph"_a)
      .def("predict",
  ...
  // KWL2Features
  py::class_<feature_generator::KWL2Features, feature_generator::Features>(feature_generator_m,
                                                                           "KWL2Features")
      .def(py::init<const std::string &>(), "filename"_a)
      .def(py::init<const std::string &, bool>(), "filename"_a, "quiet"_a)
      .def(py::init<planning::Domain &, std::string, int, std::string, bool>(),
  ...
  // IWLFeatures
  py::class_<feature_generator::IWLFeatures, feature_generator::Features>(feature_generator_m,
                                                                          "IWLFeatures")
      .def(py::init<const std::string &>(), "filename"_a)
      .def(py::init<const std::string &, bool>(), "filename"_a, "quiet"_a)
      .def(py::init<planning::Domain &, std::string, int, std::string, bool>(),
  ...
  // NIWLFeatures
  py::class_<feature_generator::NIWLFeatures, feature_generator::IWLFeatures>(feature_generator_m,
                                                                              "NIWLFeatures")
      .def(py::init<const std::string &>(), "filename"_a)
      .def(py::init<const std::string &, bool>(), "filename"_a, "quiet"_a)
      .def(py::init<planning::Domain &, std::string, int, std::string, bool>(),
  ...
  // CCWLFeatures
  py::class_<feature_generator::CCWLFeatures, feature_generator::WLFeatures>(feature_generator_m,
                                                                             "CCWLFeatures")
      .def(py::init<const std::string &>(), "filename"_a)
      .def(py::init<const std::string &, bool>(), "filename"_a, "quiet"_a)
      .def(py::init<planning::Domain &, std::string, int, std::string, bool>(),
